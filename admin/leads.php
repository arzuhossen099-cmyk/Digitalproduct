...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="btn-group">
        ...
        <button class="btn btn-lp-outline ms-2"><i class="fas fa-trash me-2"></i> Bulk Delete</button>
    </div>
</div>
...
<div class="lp-table-container">
    <table class="lp-table">
        ...
        <tbody>
            ...
            <tr>
                <td><input type="checkbox" class="form-check-input bg-dark border-secondary"></td>
                ...
                <td>
                    <div class="btn-group">
                        ...
                        <button class="btn btn-sm btn-lp-outline px-2 py-0 text-danger border-danger border-opacity-25"><i class="fas fa-trash small"></i></button>
                    </div>
                </td>
            </tr>
            <?php endforeach; ?>
