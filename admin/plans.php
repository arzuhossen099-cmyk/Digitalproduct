...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <button class="btn btn-lp-primary" data-bs-toggle="modal" data-bs-target="#planModal"><i class="fas fa-plus me-2"></i> New Plan</button>
</div>
    ...
    <div class="col-md-4">
        <div class="lp-card h-100">
            ...
            <ul class="list-unstyled small mb-4">
                <li class="mb-2"><i class="fas fa-check text-success me-2"></i> <?php echo number_format($plan['credits_per_month']); ?> Credits/mo</li>
                <li class="mb-2"><i class="fas fa-check text-success me-2"></i> <?php echo number_format($plan['searches_per_day']); ?> Searches/day</li>
